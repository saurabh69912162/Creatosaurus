...
class current_package_user_admin(admin.ModelAdmin):
	...
	list_display = ('username','dirtybit','package_selected','last_package','package_exipry','queue_size','account_connection_size','team_member_size')
	...
	ordering = ('username','dirtybit','package_selected','last_package','queue_size','account_connection_size','team_member_size')
